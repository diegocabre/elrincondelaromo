  ...
  return (
    <main className="min-h-screen bg-[#FDFCF8] flex flex-col items-center pt-32 pb-24 px-6 md:px-12">
      ...
      >
        ...
        >
          <span className="text-[#8B5E3C] font-semibold tracking-widest uppercase text-sm mb-4 block">
            Hablemos
          </span>
          ...
          <p className="text-lg text-[#6B5A4E] font-light">
            Estamos aquí para responder tus consultas, sugerencias o simplemente
            para conversar sobre tu próxima visita al Rincón del Aromo.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <motion.div
            variants={fadeUp}
            className="lg:col-span-2 bg-[#FAEDDF] rounded-[2rem] p-10 flex flex-col gap-8 shadow-sm"
          >
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#8B5E3C] uppercase tracking-wide">
                  Dirección
                </h3>
                <p className="text-[#4A3B32] mt-1">
          ...
          <motion.div
            variants={fadeUp}
            className="lg:col-span-3 bg-white rounded-[2rem] p-10 shadow-xl border border-[#EACCA4]/30"
          >
            <h2 className="text-2xl font-bold text-[#4A3B32] mb-8">
              Envíanos un Mensaje
            </h2>
            ...
            <form action={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="nombre"
                    className="text-sm font-semibold text-[#8B5E3C] uppercase tracking-wide"
                  >
                    Nombre completo
                  </label>
                  <input
