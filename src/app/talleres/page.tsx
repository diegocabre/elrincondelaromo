  ...
  return (
    <main className="min-h-screen bg-[#FDFCF8] flex flex-col items-center pt-32 pb-24 px-6 md:px-12">
      <motion.div 
        ...
        className="w-full max-w-6xl flex flex-col items-center gap-20"
      >
        ...
        {loading ? (
           <p className="text-[#8B5E3C] py-20 font-medium">Buscando próximos talleres...</p>
        ) : (
          <div className="w-full flex flex-col gap-24">
            ...
            <div>
               ...
               {activos.length === 0 ? (
                 ...
                 <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
                    {activos.map(taller => (
