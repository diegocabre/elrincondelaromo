        ...
        <div className="flex min-h-screen bg-[#FDFCF8]">
            ...
            <aside className="hidden md:flex flex-col w-72 bg-white shadow-xl border-r border-[#EACCA4]/30">
                ...
                <nav className="flex-1 py-6 px-4 flex flex-col gap-2">
                    ...
                    >
                        <UserCircle2 className="w-5 h-5" /> Gestión Usuarios
                    </Link>
                </nav>

                <div className="p-4 border-t border-[#EACCA4]/30 flex flex-col gap-2">
                    <Link
                        href="/admin/cuenta"
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-medium text-[#8B5E3C] bg-[#FAEDDF] hover:bg-[#F2DBBF] transition-colors"
                    >
                        <Settings className="w-5 h-5" /> Mi Cuenta
                    </Link>
                    <button
